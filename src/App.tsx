      ...
      {({ signOut, user }) => {
        ...
        return (
            <>
                ...
                <Button onClick={async () => console.log(await addItem('c#99887766', 'c#99887766', 'customer', currentDate.toString(), 'test_user@email.com', 'attack helicopter', 'Major Major Major', null, null, null, null, null))}>Create new item</Button>
