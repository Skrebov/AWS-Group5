      ...
      {({ signOut, user }) => {
        ...
        return (
            <>
                ...
                <Button onClick={async () => console.log(await addCustomer('c#99887766', 'c#99887766', time.toString(), 'test_user@email.com', 'attack helicopter', 'Major Major Major', null))}>Create new customer</Button>
                <Button onClick={async () => console.log(await addInvoice('i#99887766', 'c#99887766', time.toString()))}>Create invoice for current date</Button>
